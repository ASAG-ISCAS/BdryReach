...
#ifndef POLYREACHOPTIONS_H
#define POLYREACHOPTIONS_H
 ...
 */
   ...
   */
		...
		polyZonotope<Number> Rhom_;
		polyZonotope<Number> Rhom_tp_;
   ...
   * @return the R0
   */
		const polyZonotope<Number> R0() const;

		/**
   * @brief Replaces the R0 with the parameter
   * @param R0
   */
		void set_R0(polyZonotope<Number> R0);
   ...
   * @return the Rhom
   */
		const polyZonotope<Number> Rhom() const;

		/**
   * @brief Replaces the Rhom with the parameter
   * @param Rhom
   */
		void set_Rhom(polyZonotope<Number> Rhom);

		/**
   * @brief Get the Rhom_tp
   * @return the Rhom_tp
   */
		const polyZonotope<Number> Rhom_tp() const;

		/**
   * @brief Replaces the Rhom_tp with the parameter
   * @param Rhom_tp
   */
		void set_Rhom_tp(polyZonotope<Number> Rhom_tp);
   ...
   */
    ...
    /**
   * @brief Get the volApproxMethod
   * @return the volApproxMethod
   */
        const std::string volApproxMethod() const;

    /**
   * @brief Replaces the volApproxMethod with the parameter
   */
		void set_volApproxMethod(std::string volApproxMethod);
	};
	/** @} */
} // namespace reachSolver
