...
public:
  ...
  */
   ...
   * @param order - order of Taylor method (degree of polynomial approximation to the solution)
   * @param[in] coeffs[0] - jets of initial conditions for the solution and all variational equations
   * @param[out] coeffs[1],...,coeffs[order] - computed coefficients  of polynomial approximation to the solution all variational equations
